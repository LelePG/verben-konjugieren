    ...
    <v-container >
      <v-row >
        <v-col md="3">
          ...
          <v-checkbox
            v-model="temposVerbais"
            label="Plusquamperferkt"
            value="PLUSQUAMPERFEKT"
            color="#6B705C"
          >
          </v-checkbox>
        </v-col>
